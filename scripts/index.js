...
function updateCountdown() {
  ...
  if (difference > 0) {
    ...
    // Alterar o título quando o sorteio chegou
...
// Smooth scroll para o regulamento
document
  .querySelector('a[href="#regulamento"]')
  .addEventListener("click", function (e) {
    e.preventDefault();
    document.getElementById("regulamento").scrollIntoView({
      behavior: "smooth",
    });
  });
